...
import MovieListsA from './PopularMovies';
  ...
  return (
    <div className="homepage">
        <div className="hero-section">
            <img src={Poster} alt=""  className='logo bg-gradient-to-l md:bg-gradient-to-r w-full h-full'/>
            <div className="nav w-full absolute top-4">
              ...
              <span className='flex flex-row space-x-3'>
                ...
                <button className="btn btn-square btn-ghost mr-24">
            ...
            <div className="description-box flex flex-col w-3/12 absolute top-40 justify-start text-white space-y-4 items-start text-left">
              ...
              <img src={Ratings} alt="" />
                <p>John Wick is on the run after killing a member of the international assassins'
                 guild, and with a $14 million price tag on his head,
                  he is the target of hit men and women everywhere.
                </p>
               <button type="submit">
               <a href="https://www.youtube.com/watch?v=vIipsYDZDd4">
                <img src={Trailer} alt="" /></a></button>
            </div>
        </div>
